...
insert into tb_pizza (sabor, borda_recheada, preco, fk_id_categoria) values ("calabresa", true, 35.50, 4);
...
insert into tb_pizza (sabor, borda_recheada, preco, fk_id_categoria) values ("Da casa", false, 35.50, 6);
